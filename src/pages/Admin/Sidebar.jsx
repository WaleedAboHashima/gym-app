...
const Sidebar = () => {
  ...
  return (
      ...
      <div className='flex flex-col gap-y-10 p-10'>
          ...
          <span className={`text-white text-3xl w-full text-right  hover:bg-neutral-400 cursor-pointer px-3 py-2 ${activeSide ==="add_club" && "bg-white text-neutral-700 transition-all"}`} onClick={()=>window.location.pathname="/admin/add_club"} >اضافه نادي</span>
